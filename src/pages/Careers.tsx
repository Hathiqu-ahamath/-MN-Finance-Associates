      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            {positions.map((pos, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className="bg-light p-6 rounded-2xl border border-border flex flex-col md:flex-row justify-between items-center hover:border-accent/30 transition-all group"
              >
                <div className="mb-4 md:mb-0">
                  <h3 className="text-xl font-bold text-primary group-hover:text-secondary transition-colors">{pos.title}</h3>
                  <div className="flex space-x-4 mt-2 text-sm text-textSecondary font-medium">
          ...
          <div className="mt-16 text-center">
            <p className="text-textSecondary mb-6 italic">Don't see a position that fits? Send us your CV anyway!</p>
